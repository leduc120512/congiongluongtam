...
<head>
    ...
    <link rel="canonical" href="https://congiongluongtam.com/" />

    <link rel="icon" href="https://congiongluongtam.com/view/images/logomain.jpg" type="image/jpeg">
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "Con Giống Lương Tâm",
            "url": "https://congiongluongtam.com",
            "logo": "https://congiongluongtam.com/view/images/logomain.jpg",
            "sameAs": [
                "https://www.facebook.com/congiongluongtam"
            ]
        }
    </script>
</head>
<style>
    ...
    .support-item img.logo {
        height: 22px;
        margin-right: 10px;
        object-fit: contain;
    }

    .support-item a.phone {
        font-size: 16px;
        font-weight: bold;
        color: #d63031;
        text-decoration: none;
    ...
    .support-item a.phone:hover {
        color: #c0392b;
    }

    .support-item a.zalo-icon img {
        width: 26px;
        height: 26px;
        transition: transform 0.3s ease;
    }

    .support-item a.zalo-icon:hover img {
        transform: scale(1.2);
    }
    ...
    /* Kiểu mặc định đã được nhúng inline trong HTML, nên media query sẽ ghi đè */

    /* Media query cho màn hình điện thoại (dưới 768px) */
    @media only screen and (max-width: 768px) {
        .support-widget {
            font-size: 5.8px !important;
            /* Giảm từ 11px xuống 5.5px */
        }
        ...
        .support-item .logo {
            ...
            /* Giảm từ 12px xuống 6px */
            margin-right: 2.5px !important;
            /* Giảm từ 5px xuống 2.5px */
        }
        ...
        .support-item .zalo-icon {
            margin-left: 4px !important;
            /* Giảm từ 8px xuống 4px */
        }

        .support-item .zalo-icon img {
            width: 7px !important;
            /* Giảm từ 14px xuống 7px */
...
<body>
    ...
    <section class="el">
        <div
            class="slideshow slide-in arrow-absolute text-white position-relative el">
                        ...
                        <div class="container">
                            <div class="row justify-content-center text-center">
                                <div class="col-md-12 pt-2">
                                    ...
                                    <a href="#" class="btn btn-primary rounded-3 px-3 py-2 mt-3" id="shop-now-btn-sn">Sản phẩm</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section style="display: flex; justify-content: center;" class="new-arrivals section-padding el">
                                ...
                                <div class="product-item mb-4">
                                    ...
                                    <div class="d-flex flex-column text-center">
                                        ...
                                        <div class="button-area p-3">
                                            ...
                                            <div>
                                                <a style="background-color: #76ACCD !important;" class="btn rounded-1 p-2 fs-7 consult-btn btn-cart" data-product-id="<?php echo $product['ID']; ?>">
                                                    <svg width="18" height="18">
                                                        <use xlink:href="#cart"></use>
                                                    </svg> Mua hoặc liên hệ
                                                </a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="offcanvas-body mess_l1131ist justify-content-center" style="margin-bottom: 10px; padding-bottom: 20px;">
        <ul class="custom-nav mb-0" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; padding: 0; list-style: none; width: 100%;">
            ...
            <li class="custom-item" style="flex: 1 1 calc(33.33% - 10px); min-width: 100px; margin: 0; text-align: center;">
                <select id="categorySelect_art1" class="form-select fw-bold nav-link dropdown-toggle custom-dropdown" onchange="changeCategoryArt1()" style="width: 100%; padding-left: 22px;">
                            ...
                            <div class="product-item mb-4">
                                ...
                                <div class="d-flex flex-column text-center">
                                    ...
                                    <div class="button-area p-3">
                                        ...
                                        <div>
                                            <a style=" width: 100px;;background-color: #76ACCD !important;" class="btn rounded-1 p-2 fs-7 consult-btn btn-cart" data-product-id="<?php echo $product['ID']; ?>">
                                                <svg width="18" height="18">
                                                    <use xlink:href="#cart"></use>
                                                </svg> Mua hoặc liên hệ
                                            </a>
                                                ...
                                                <div class="product-item mb-4">
                                                    ...
                                                    <div class="d-flex flex-column text-center">
                                                        ...
                                                        <div class="button-area p-3">
                                                            ...
                                                            <div>
                                                                <a class="btn btn-cart rounded-1 p-2 fs-7 consult-btn" style="background-color: #76ACCD !important;" data-product-id="<?php echo $product['ID']; ?>">
                                                                    <svg width="18" height="18">
                                                                        <use xlink:href="#cart"></use>
                                                                    </svg>
                                                                    <p> Mua hoặc liên hệ</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <ul class="pagination justify-content-center">
                                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                    <li class="page-item <?= $i == $currentPage ? 'active' : '' ?>">
                                        <a class="page-link"
                                            href="?controller=product&action=index&search=<?= urlencode($keyword ?? '') ?>&category_id=<?= urlencode($category_id ?? '') ?>&sort=<?= urlencode($sort ?? '') ?>&page=<?= $i ?>">
                                            <?= $i ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            ...
                            <blockquote>
                                "Cửa hàng gà vịt này có mọi thứ tôi cần! Gà tươi ngon, giá hợp lý, nhân viên rất nhiệt tình. Rất đáng tin cậy!"
                            </blockquote>
                            <h5 class="mt-1 fw-normal">Chị Lan, khách hàng quen thuộc</h5>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div
                            class="card position-relative text-left p-5 border-light shadow-sm rounded-3">
                            <blockquote>
                                "Tôi đã mua vịt ở đây vài lần, thịt chắc, sạch sẽ, giao hàng nhanh chóng. Rất hài lòng!"
                            </blockquote>
                            <h5 class="mt-1 fw-normal">Anh Minh, đầu bếp tại gia</h5>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div
                            class="card position-relative text-left p-5 border-light shadow-sm rounded-3">
                            <blockquote>
                                "Giao hàng tận nơi rất tiện lợi. Gà ta đúng chuẩn, ăn rất ngon và chắc thịt. Sẽ ủng hộ lâu dài!"
                            </blockquote>
                            <h5 class="mt-1 fw-normal">Chị Hằng, nội trợ</h5>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div
                            class="card position-relative text-left p-5 border-light shadow-sm rounded-3">
                            <blockquote>
                                “Tôi rất ưng ý với dịch vụ ở đây. Gà và vịt đều tươi sống, đóng gói cẩn thận, giao đúng giờ.”
                            </blockquote>
                            <h5 class="mt-1 fw-normal">Anh Quân, chủ quán ăn</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-5">
                    <h2 class="fw-bold fs-1 mt-5">
                        Ưu đãi <span class="text-primary">25% cho khách mới</span>
                    </h2>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <h5 class="fs-5 fw-normal">Giao Hàng Tận Nơi</h5>
                        <p class="card-text">
                            Hỗ trợ giao gà, vịt giống tận nơi toàn quốc – nhanh chóng, an toàn, đúng hẹn.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <h5 class="fs-5 fw-normal">Thanh Toán An Toàn</h5>
                        <p class="card-text">
                            Đảm bảo thanh toán minh bạch, bảo mật – nhận hàng rồi mới thanh toán (COD).
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <h5 class="fs-5 fw-normal">Cam Kết Con Giống Chuẩn</h5>
                        <p class="card-text">
                            Gà, vịt giống khỏe mạnh, nhanh lớn, đúng giống – có giấy kiểm dịch rõ ràng.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <h5 class="fs-5 fw-normal">Ưu Đãi Hàng Ngày</h5>
                        <p class="card-text">
                            Giảm giá theo số lượng, quà tặng cho đơn hàng lớn – cập nhật liên tục mỗi ngày!
                        </p>
                    </div>
                </div>
  ...
  ">Mua ngay</button>
    ...
    <div class="modal-content">
      ...
      <form id="consultForm" method="POST" action="/order/create">
        <input type="hidden" id="modalProductId" name="product_id">
        <input type="hidden" id="formAction" name="action" value="contact">
        <div>
          <label for="name">Họ và tên:</label>
    ...
    <?php
    $address = "Tầng 5, 23 Lê Văn Lương, Hà Nội";
    ...
    <a href="<?php echo $mapLink; ?>" target="_blank" class="btn btn-outline-primary mt-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('contactBtn').addEventListener('click', () => {
                document.getElementById('formAction').value = 'contact';
                form.requestSubmit(); // Gửi form đúng cách
            });

            // ✅ Xử lý nút "Mua ngay"
            document.getElementById('buyBtn').addEventListener('click', () => {
                document.getElementById('formAction').value = 'buy';
                form.requestSubmit();
            });
            ...
            <div class="product-item mb-4">
              ...
              <div class="d-flex flex-column text-center">
                ...
                <div class="button-area p-3">
                  ...
                  <a style="background-color: #76ACCD !important;" class="btn btn-cart rounded-1 p-2 fs-7 consult-btn" data-product-id="${product.ID}">
                    <svg width="18" height="18"><use xlink:href="#cart"></use></svg> Mua ngay hoặc liên hệ
                  </a>
                </div>
              </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('shop-now-btn-sn').addEventListener('click', function(event) {
            event.preventDefault(); // Prevent default link behavior
            document.querySelector('.el').style.display = 'none'; // Hide the section with class "el"
        });
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
    ...
    <script>
      ...
      `;
        ...
        function changeCategoryArt1() {
            const select = document.getElementById('categorySelect_art1');
            const categoryId = select.value;
            ...
            // Lưu trạng thái vào sessionStorage để biết đã chọn danh mục
            sessionStorage.setItem('category_art_selected', 'true');
        ...
        //fm
        function changeCategoryFm1() {
            const select = document.getElementById('categorySelect_fm1');
            const categoryId = select.value;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const indexPv = document.querySelector('.index_pv');
            ...
            if (select && form) {
                select.addEventListener('change', () => {
                    ...
                    // Gán margin-top: 40px cho index_pv trước khi submit
                    if (indexPv) {
                        indexPv.style.marginTop = '40px';
                    }
            ...
            // Optional: Ẩn phần tử .el nếu có tham số category_id trên URL
            const urlParams = new URLSearchParams(window.location.search);
            if (urlParams.has('category_id')) {
                document.querySelectorAll('.el').forEach(el => el.style.display = 'none');

                // Gán margin-top: 40px cho index_pv khi truy cập từ category_id
                if (indexPv) {
                    indexPv.style.marginTop = '40px';
                }
            }
