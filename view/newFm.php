        ...
        <div class="container-lg">
            <div class="row">
                <div class="section-header mb-3">
                    <h2 class="section-title text-success">Bài báo</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="related-list">
                        <?php foreach ($categoryartProductsone as $process): ?>
                            <div class="related-item d-flex align-items-start mb-3">
                                <a href="?controller=article&action=detail_Art&id=<?= htmlspecialchars($process['ID']) ?>">
