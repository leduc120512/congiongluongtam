    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="container mt-5">
                <h2> Quản lí danh mục bài báo</h2>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <form action="?controller=category_art&action=index" method="GET" class="input-group">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Tìm kiếm theo tên" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                            <button type="submit" class="btn btn-primary">Tìm kiếm</button>
                        </form>
                    </div>
                    <div class="col-md-6 text-end">
                        <a href="?controller=category_art&action=create_category" class="btn btn-primary">Thêm 1 danh mục bài báo</a>
                        <a href="?controller=category_art&action=index&top_only=1" class="btn btn-secondary">Top danh mục</a>
                    </div>
                </div>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Tên</th>
                            <th>Mô tả</th>
                            <th>Top</th> <!-- hoặc "Nổi bật" tùy ngữ cảnh -->
                            <th>Ngày tạo</th>
                            <th>Hành động</th>
                    ...
                    <tbody>
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?controller=category_art&action=edit_category&id=<?php echo htmlspecialchars($category['id'] ?? ''); ?>" class="btn btn-sm btn-warning">Sửa</a>
                                    <a href="?controller=category_art&action=delete_category&id=<?php echo htmlspecialchars($category['id'] ?? ''); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc xóa?')">Xóa</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
