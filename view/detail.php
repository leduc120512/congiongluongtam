...
<head>
    ...
    <!-- Meta Description -->
    <meta name="description" content="<?php echo htmlspecialchars(mb_substr(strip_tags($product['description']), 0, 150)); ?>">

    <!-- Canonical -->
    <link rel="canonical" href="https://congiongluongtam.com/?controller=product&action=detail&id=<?php echo htmlspecialchars($product['ID']); ?>" />

    <!-- Title -->
    <title><?php echo htmlspecialchars($product['name']) . ' - Con Giống Lương Tâm'; ?></title>
    ...
    <script type="application/ld+json">
        {
            ...
            "sameAs": [
                ...
                $schema = [
                    ...
                    "name" => $product['name'],
                    "image" => [
                        "https://congiongluongtam.com/public/img/" . ($product['images'][0]['image_url'] ?? 'placeholder.jpg')
                    ],
                        ...
                        <?php endif; ?>
                            ...
                            <div class="product-preview">
                                <div class="product-main-image">
                                    <?php if (!empty($product['images'])): ?>
                                        <img id="mainImage" src="../public/img/<?php echo htmlspecialchars($product['images'][0]['image_url']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">

                                    <?php else: ?>
                                        <img id="mainImage" src="../public/img/placeholder.jpg" alt="<?php echo htmlspecialchars($product['name']); ?>">
                                    <?php endif; ?>
                                </div>
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <div class="mt-4">
                            <form id="reviewForm" method="POST" action="?controller=product&action=addReview" class="space-y-4">
                                ...
                                <button style="width: 160px !important; text-align: center; display: flex;justify-content: center; align-items: center; " type="submit" class="btn-shopee">Gửi đánh giá</button>
                            </form>
                        </div>
                    <?php else: ?>
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <div class="mb-6">
                                <form id="commentForm" method="POST" action="?controller=product&action=addComment" class="space-y-4">
                                    ...
                                    <button style="width: 160px !important; " class="btn-shopee">Gửi bình luận</button>
                                </form>
                            </div>
                        <?php else: ?>
