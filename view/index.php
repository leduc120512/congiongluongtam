        ...
        <li class="nav-item position-relative">
          <a class="btn btn-toggle dropdown-toggle w-100 d-flex justify-content-between align-items-center p-2"
            ...
            <div class="d-flex gap-3">
              ...
              <span>Gia cầm khác</span>
            </div>
          </a>
          <div class="collapse" id="beverages-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
              <li class="border-bottom py-2">
                <a href="shop.html" class="dropdown-item">Chim bồ câu</a>
              </li>
              <li class="border-bottom py-2">
                <a href="shop.html" class="dropdown-item">Gà tây</a>
              </li>
              <li class="border-bottom py-2">
                <a href="shop.html" class="dropdown-item">Đà điểu</a>
              </li>
              <li class="border-bottom py-2">
                <a href="shop.html" class="dropdown-item">Công</a>
              </li>
            </ul>
          </div>
        </li>
    ...
    <div class="col-md-8 list_item">
      <div class="container-lg position-relative">
        <div class="section-header d-flex flex-wrap justify-content-between pb-2">
          <h2 class="section-title">Top gia cầm bán chạy</h2>
        </div>
