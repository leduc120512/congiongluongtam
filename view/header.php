                    ...
                    <ul class="navbar-nav mb-0">
                        ...
                        <form id="searchSortOnlycategory1" class="search-sort-form row g-3 align-items-center" method="GET" action="/" style="display: flex; justify-content: center;">
                            ...
                            <div class="col-md-12 select_leduc" style="display: flex; justify-content: center; position: relative;">
                                ...
                                <!-- Select box -->
                                <select name="category_id" id="categoryOnlySelect1" class="form-select fw-bold nav-link dropdown-toggle" style="opacity: 0;">
                        ...
                        <form id="searchSortOnlycategory" class="search-sort-form row g-3 align-items-center" method="GET" action="/" style="display: flex; justify-content: center;">
                            ...
                            <div class="col-md-12 select_leduc" style="display: flex; justify-content: center; position: relative;">
                                ...
                                <!-- Select box -->
                                <select name="category_id" id="categoryOnlySelect" class="form-select fw-bold nav-link dropdown-toggle" style="opacity: 0;">
                        ...
                        <form id="searchSortOnlycategory2" class="search-sort-form row g-3 align-items-center" method="GET" action="/" style="display: flex; justify-content: center;">
                            ...
                            <div class="col-md-12 select_leduc" style="display: flex; justify-content: center; position: relative;">
                                ...
                                <!-- Select box -->
                                <select name="category_id" id="categoryOnlySelect2" class="form-select fw-bold nav-link dropdown-toggle" style="opacity: 0;">
