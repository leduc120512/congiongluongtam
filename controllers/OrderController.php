...
class OrderController
{
    ...
    public function myOrders()
    {
        ...
        require __DIR__ . '/../view/my_orders.php';
    }
    ...
    public function admin()
    {
        ...
        require __DIR__ . '/../view/admin_order.php';
    }
    ...
    public function create()
    {
        ...
        if ($result['success']) {
            ...
            try {
                ...
                $mail->isHTML(true);
                $action_text = ($buy_not === 1) ? 'Liên hệ' : 'Mua ngay';
                ...
                <body style="margin: 0; padding: 0; font-family: Arial, sans-serif;">
                    <div style="max-width: 600px; margin: 20px auto; border: 2px dashed #ff9900; padding: 20px; background: #fffbe6; border-radius: 10px;">
                        <h2 style="color: #d35400; text-align: center;">Có khách ' . $action_text . ' liền tay! </h2>
                        <p style="font-size: 16px; color: #333;"><strong>Hành động:</strong> <span style="color: #8e44ad;">' . $action_text . '</span></p>
